...
const products = [
    ...
    { name:'XL Beeswax Wrap', price:'$20.00', image: 'images/Large-Beeswax-Wraps.jpeg', description:'The perfect everyday set for ditching plastic wrap. Press a wrap over a bowl, fold one around a sandwich, or seal the top of a jar — the warmth of your hands molds it into place, and the beeswax formula holds the cling. When you\'re done, a quick rinse in cool water and it\'s ready for next time. ', benefits:'Wrap • Cold Wash Only', disclaimer:'Care Instructions: Use cold water with a damp cloth and gently wash. Hang to dry.', link:'checkout.html' },
